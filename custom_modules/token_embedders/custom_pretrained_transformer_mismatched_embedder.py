...
class CustomPretrainedTransformerMismatchedEmbedder(TokenEmbedder):
    """
    This is a customized version of the AllenNLP PretrainedTransformerMismatchedIndexer,
    that addtionally allows for passing a sub_module parameter. (based on allennlp v2.2.0)
    ...
    Registered as a `TokenEmbedder` with name "custom_pretrained_transformer_mismatched".
